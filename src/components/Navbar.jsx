...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center w-full h-20 bg-black text-pink-300 fixed px-4'>
            <div>
            ...
            <ul className='hidden md:flex'>
                ...
                <li key={id} className='px-4 cursor-pointer capitalize font-medium text-pink-500 hover:scale-105 duration-200'>
